  ...
  return (
    <div className="flex items-center justify-center space-x-4 h-3 ">
      ...
      {status=="true" &&<div className="relative inline-flex items-center cursor-pointer">
        <span className={`text-sm font-medium ${status === "true" ? "text-green-600" : "text-gray-600"}`}>
        ...
        <div
          ...
          className={`w-8 h-4 flex items-center rounded-full p-1 transition-colors duration-300 ease-in-out ${status === "true" ? "bg-green-500" : "bg-gray-400"}`}
        >
